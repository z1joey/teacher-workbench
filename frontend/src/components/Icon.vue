<script setup>
// Dependency-free stroke icon set (24×24, stroke = currentColor), drawn for
// this app: board = the classroom chalkboard, clipboard = exams, home = visits,
// alert = weaknesses, pencil = score corrections, swap = class moves.
const PATHS = {
