...
const messages = {
  ...
  "admin.userConfirmDelete": "确认删除该账号？此操作不可恢复。",
  "admin.userSelfDemote": "不能降级自己的角色",
  ...
  "records.title": "跟进记录",
  "records.subtitle": "共 {count} 条 · 点击学生查看完整时间线",
  "records.empty": "暂无跟进记录",
