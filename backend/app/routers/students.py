        ...
        "home_visits": [
            {
                ...
                "follow_up_needed": bool((ev.payload or {}).get("follow_up_needed", False)),
...
def delete_student(
    ...
    # KnowledgePoint, Question, QuestionResponse and StudentWeakness tables
    # have been removed; remaining evidence is ExamResult (subject-level score)
    # and home-visited events (via StudentEvent).
    ...
    if has_results or has_home_visits:
